...
- [TeaCache](Notes/vLLM-omni/docs/design/feature/teacache.md) - 基于时间步相似性的缓存加速

### 并行策略
- [CFG Parallel](cfg-parallel.md) - 无分类器引导并行
- [Expert Parallel](expert-parallel.md) - 专家并行（MoE模型）
- [HSDP](Notes/vLLM-omni/docs/design/feature/hsdp.md) - 混合分片数据并行
...
- [Sleep Mode](Notes/vLLM/features/sleep-mode.md) - 睡眠模式
